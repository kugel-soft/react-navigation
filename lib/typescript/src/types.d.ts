...
export declare type MaterialBottomTabNavigationEventMap = {
    ...
    /**
     * Event which fires on long pressing the tab in the tab bar.
     */
    tabLongPress: {
        data: undefined;
...
export declare type MaterialBottomTabNavigationConfig = Partial<Omit<React.ComponentProps<typeof BottomNavigation>, 'navigationState' | 'onIndexChange' | 'onTabPress' | 'onTabLongPress' | 'renderScene' | 'renderLabel' | 'renderIcon' | 'getAccessibilityLabel' | 'getBadge' | 'getColor' | 'getLabelText' | 'getTestID'>>;
